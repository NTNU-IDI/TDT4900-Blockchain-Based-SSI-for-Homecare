...
import { getHealthRecordHash, hasAccess, hasRequestedAccess } from "./contractService";
...
export async function fetchAllPatients(ownerAddresses: string[]): Promise<Patient[]> {
